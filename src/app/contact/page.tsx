      ...
      <div className="px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700 neon-glow">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-300">
                    I typically respond within 24 hours. Whether 
                    you need a website, Discord bot, or data 
                    scraper, I&apos;m here to help bring your ideas to 
                    life.
                  </p>
                </div>
              </div>
            ...
            {/* Contact Form */}
            <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700 neon-glow">
              ...
              {state.succeeded ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-800 disabled:opacity-50"
                  >
