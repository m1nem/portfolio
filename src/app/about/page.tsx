    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <div className="px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-1 xl:grid-cols-2 gap-12 items-center mb-16">
            <div className="bg-slate-800/50 rounded-2xl p-6 sm:p-8 border border-slate-700 neon-glow">
              <p className="text-gray-300 leading-relaxed">
                Hey! name&apos;s <span className="text-white font-semibold">m1nem</span>. I&apos;m a teenager trying
                to raise some college funds. I build websites, work with databases, and create simple graphics.
                This portfolio showcases my projects and how I break down code like a pro.
              </p>
            </div>

            <div className="relative">
              <div className="bg-slate-800/50 rounded-2xl p-4 sm:p-6 border border-slate-700 neon-glow">
